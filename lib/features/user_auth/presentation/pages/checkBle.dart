...
class CheckBle extends StatefulWidget {
  const CheckBle({super.key});

  @override
  State<CheckBle> createState() => _CheckBleState();
}

class _CheckBleState extends State<CheckBle> {
  ...
  void initState() {
    ...
    _scanResultsSubscription = FlutterBluePlus.scanResults.listen((results) {
      ...
      showToast(message: "Scan Error:$e");
    });
